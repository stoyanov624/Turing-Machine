...
//}
//
//WhileComposedTM& WhileComposedTM::operator=(const WhileComposedTM& other_wctm) {
//	if (this != &other_wctm) {
//		machine_ID = other_wctm.machine_ID;
//		tape = other_wctm.tape;
//		decider = other_wctm.decider;
//		tm = other_wctm.tm;
//	}
//
//	return *this;
...
//}
//
//void WhileComposedTM::saveMachine() {}